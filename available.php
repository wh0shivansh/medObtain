...
require_once('./config.php');
    ...
    if($option === "blood" && isset($_GET['type'])){
        $type=$_GET['type'];
        $outputOption = "Blood";
        if($type=="a"){
          $outputType="A+";
    ...
    else if($option === "oxygencyl"){
      $outputOption = "Oxygen Cylinder";
      $outputType = "";
        $sql = "SELECT * from data WHERE $option = 1";
    }
...
<body>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./Assets/emergency.jpg" alt="">
      </div>
      <div class="swiper-slide">
        <img src="./Assets/emergency.jpg" alt="">
      </div>
  ...
  <div class="container-fluid quick-service-section" id="urgent-need">
    <h1 style="font-family:'lato';font-weight:bold;">Here We <span class="color-green">Go!</span></h1>
    <h3 style="font-family:'lato';font-weight:bold;" class="mt-30">here is the list of all the organisations where <?php echo $outputType." ".$outputOption." is available right now."?></h3>
    <div class="row d-flex flex-column " >

<table class="table mt-30 ">
  <thead class="thead" style="background-color:var(--green);color:#feffff;">
    <tr class="table-row">
      <th scope="col">Sno</th>
...
<div class="my-container" style="height:11rem;width:100%">
